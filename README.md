...
[![GitHub CI](https://github.com/metwork-framework/docker-mfext-centos6-buildimage/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/metwork-framework/docker-mfext-centos6-buildimage/actions?query=workflow%3ACI+branch%3Amaster)
